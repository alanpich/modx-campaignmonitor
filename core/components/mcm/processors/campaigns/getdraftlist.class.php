...
class McmDraftCampaignGetListProcessor extends modObjectGetListProcessor {
...
public function process() {
		...
		$response = $this->MCM->getDraftCampaignList( $limit, $start);
        $data = $response->data;
...
return 'McmDraftCampaignGetListProcessor';
